# 🧑‍💻 LeetCode Java Submissions Repository
...
- Browse by difficulty folders: `Easy/`, `Medium/`, `Hard/`
- Each solution is commented (sometimes with actual explanations, sometimes with existential questions).
